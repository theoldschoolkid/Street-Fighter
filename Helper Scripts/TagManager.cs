...
/// <summary>
/// A seperate class used to convert words that define animations,tags, inputs into a constant public string
/// </summary>
public class AnimationTags {
    ...
    public const string GROUNDPUNCH_TRIGGER = "GroundPunch";
    public const string GROUNDKICK_TRIGGER = "GroundKick";
...
public class Tags {
    ...
    public const string ENEMY_CHILD_TAG = "EnemyChild";
